...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    className={`mt-2 rounded-md border border-slate-300 bg-slate-100 p-6 dark:border-slate-700 dark:bg-slate-900 ${className}`}
    {...props}
    ref={ref}
  />
));
